...
const DoctorSlider = () => {
    ...
    const doctorsPerPage = isXs ? 1 : isSm ? 2 : isMd ? 2 : isLg? 4: 4;
        ...
        <Box display='flex' width='100%' justifyContent='center' marginTop={5}>
            <Grid container display='flex' sx={{width: { lg: '90%', md: "90%", sm: "100%", xs:"90%"}}} alignItems='center' marginTop={5} justifyContent='space-between'>
                <Grid item lg={2} md={4} sm={4} xs={12}>
                    <Typography variant="h4" fontWeight="bold" onClick={() => dispatch(setPage(1))} sx={{ cursor: 'pointer' }}>
                        Our Doctors
                    </Typography>
                </Grid>
                <Grid item lg={6} md={6} sm={6} xs={12} sx={{paddingX:{xs:'0px',sm:'20px' }, marginTop:{xs:'0px',sm:'0px' }}}>
